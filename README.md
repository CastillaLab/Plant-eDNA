...
- **lakes_traits.csv**: Dataset containing variables describing sampling timing (Julian day), lake characteristics (lake area and maximum depth), and surrounding landscape features, including IWS stream density and the percentage of different land cover types. 
