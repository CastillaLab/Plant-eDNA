...
- **lakes traits.csv**: Dataset containing variables describing sampling timing (Julian day), lake characteristics (lake area and maximum depth), and surrounding landscape features, including hydrological connectivity (IWS stream density) and the percentage of different land cover types (agriculture, developed land, forest). 
